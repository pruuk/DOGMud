---
name: "source-command-playtest"
description: "Run an AI playtest session by driving the mudagent adapter"
---

# source-command-playtest

Use this skill when the user asks to run the migrated source command `playtest`.

## Command Template

# /playtest `<local|prod> <personality> [goals-file]`

The DOGMud Codex driver for the GoMud-Module-Playtest-Harness. It spawns
...
Gameplay report (Codex-owned) under
