...
// AND the shipped start/trigger/end text (see each buff's
...
func SeedConditionRecordsForTest() func() {
	...
	records := []*BuffSpec{
		...
		{BuffId: BuffIdPoisoned, Name: "Poisoned", TriggerRate: "3 rounds", RoundInterval: 3, TriggerCount: 10, Flags: []Flag{Poison, SilentStart}, TickPool: "health", TickFromMagnitude: true, TriggerUserText: `<ansi fg="green">The poison burns through your veins!</ansi>`, EndUserText: "The poison in your veins finally burns itself out."},
		{BuffId: BuffIdBleeding, Name: "Bleeding", TriggerRate: "3 rounds", RoundInterval: 3, TriggerCount: 10, Flags: []Flag{Bleeding, SilentStart}, TickPool: "health", TickFromMagnitude: true, TriggerUserText: `<ansi fg="red">Blood seeps from your wounds!</ansi>`, EndUserText: "Your wounds stop bleeding."},
