...
func SeedConditionRecordsForTest() func() {
	...
	records := []*BuffSpec{
		...
		{BuffId: BuffIdBleeding, Name: "Bleeding", TriggerRate: "3 rounds", RoundInterval: 3, TriggerCount: 1, Flags: []Flag{Bleeding, SilentStart}, TickPool: "health", TickFromMagnitude: true, TriggerUserText: `<ansi fg="red">Blood seeps from your wounds!</ansi>`, EndUserText: "Your wounds stop bleeding."},
