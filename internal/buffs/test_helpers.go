...
func SeedConditionRecordsForTest() func() {
	...
	records := []*BuffSpec{
		...
		{BuffId: BuffIdBleeding, Name: "Bleeding", TriggerRate: "1 round", RoundInterval: 1, TriggerCount: 10, Flags: []Flag{Bleeding, SilentStart}, TickPool: "health", TickFromMagnitude: true, TriggerUserText: `<ansi fg="red">Blood seeps from your wounds!</ansi>`, EndUserText: "Your wounds stop bleeding."},
