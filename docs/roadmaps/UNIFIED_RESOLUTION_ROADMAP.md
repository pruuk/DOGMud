...
**Status 2026-08-18:** complete and shipped. Tasks 1 through 14 passed on the
feature branch, including full recurrence and bypass guards, the complete race
suite, isolated boot, and the required adversarial in-game matrix. The live
gate also drove regression fixes for coalesced Telnet login input, terminal
flee-admission races, and out-of-combat flee during a pending cast.
